<template>
  <div class="main-contenner">
    <div class="searchData">
      <el-form ref="form" :model="searchData" label-width="80px">
        <el-form-item label="部门名称">
          <el-input v-model="searchData.organName" />
        </el-form-item>
        ...
        <el-form-item>
          ...
          <el-button plain @click="restSearch">重置</el-button>
        </el-form-item>
      </el-form>
    </div>
    <div class="tableData">
      <div class="tableBox">
        ...
        >
          <el-table-column prop="organName" label="组织机构层级" />
          <el-table-column prop="organTypeName" label="分类" align="center" />
          <el-table-column align="center" prop="staffFullName" label="主要负责人" />
          <el-table-column align="center" prop="loginPhone" label="电话" />
          <el-table-column align="center" prop="personCount" label="人数" />
          <el-table-column align="center" prop="organStatusName" label="状态" />
          <el-table-column align="center" prop="organRemarks" label="备注" />
    ...
    >
      <OrganizationModel ref="modalForm" @close="close" @ok="modalFormOk" />
    </el-dialog>
  </div>
</template>
