<template>
  <el-form ref="form" class="funcmanang-model" label-width="120px" :rules="rules" :model="modelFromdata">
    ...
    <el-form-item label="角色描述" class="padding-box">
      <el-input v-model="modelFromdata.roleRemarks" type="textarea" :rows="4" />
    </el-form-item>
...
export default {
  ...
  methods: {
    ...
    remove(fromData, toData, obj) {
      this.checkFalse()
      const arr1 = this.modelFromdata.menuIds
      const arr2 = obj.keys
