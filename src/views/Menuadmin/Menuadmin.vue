<template>
  <div class="main-contenner">
    <div class="searchData">
      <el-form ref="form" :model="searchData" label-width="80px">
        <el-form-item label="菜单名称">
          <el-input v-model="searchData.menuName" />
        </el-form-item>
    ...
    <div class="tableData">
      <div class="tableBox" style="display: flex;">
        ...
        >
          ...
          <el-table-column prop="menuTypeName" align="center" label="类型" />
          <el-table-column prop="menuUrl" align="center" label="请求地址" />
          <el-table-column prop="menuStatusName" align="center" label="状态" />
          <el-table-column prop="menuModeName" align="center" label="连接目标" />
          <el-table-column prop="menuRemarks" align="center" label="备注" />
    ...
    <el-dialog :title="title" :lock-scroll="false" center width="50%" :visible.sync="dialogTableVisible">
      <MenuaddModel ref="modalForm" @close="close" @ok="modelFormOk" />
    </el-dialog>
  </div>
</template>
