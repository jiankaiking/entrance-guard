        ...
        <div class="searchData">
            <el-form ref="form" :model="searchData" label-width="80px">
                ...
                <el-form-item label="单元" style="width: 220px">
                    <el-input v-model="searchData.unitName"   placeholder="请输入单元名称"></el-input>
                </el-form-item>
        ...
        <div class="tableData">
            <div class="tableBox">
                <el-table :data="tableData" border empty-text style="width: 100%" v-loading="loading">
                    <el-table-column prop="buildingName" align="center" label="住宅楼名称"></el-table-column>
                    <el-table-column prop="unitName" label="单元名称" align="center"></el-table-column>
                    <el-table-column prop="floor" align="center" label="楼层"></el-table-column>
