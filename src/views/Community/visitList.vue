        ...
        <div class="searchData">
            <el-form ref="form" :model="searchData" label-width="30px">
                ...
                <el-form-item style="width: 220px">
                    <el-input v-model="searchData.visitorName"   placeholder="请输入姓名"></el-input>
                </el-form-item>
                <el-form-item  style="width: 220px">
                    <el-input v-model="searchData.visitorPhone"   placeholder="请输入电话"></el-input>
                </el-form-item>
                <el-form-item  style="width: 220px">
                    <el-input v-model="searchData.visitorCarNo"   placeholder="请输入访客车牌号"></el-input>
                </el-form-item>
                <el-form-item label-width="20px"  style="width: 220px">
                ...
                <el-form-item>
                    ...
                    <el-button type="success" @click="go" plain>访客邀请</el-button>
                </el-form-item>
            </el-form>
        </div>
        <div class="tableData">
            <div class="tableBox">
                <el-table :data="tableData" border empty-text style="width: 100%" v-loading="loading">
                    <el-table-column prop="visitorName" align="center" label="姓名"></el-table-column>
                    <el-table-column prop="visitorPhone" label="联系电话" align="center"></el-table-column>
                    <el-table-column prop="communityName" align="center" label="到访小区"></el-table-column>
                    <el-table-column prop="visitorCarNo" align="center" label="车牌号" width="90"></el-table-column>
                    <el-table-column prop="reason" label="事由" align="center"></el-table-column>
                    ...
                    <el-table-column align="center" label="人脸照片" width="80">
                        <template slot-scope="scope">
                            <el-image :src="scope.row.visitorFaceImgUrl" :preview-src-list="[scope.row.visitorFaceImgUrl]"></el-image>
                        </template>
                    </el-table-column>
                    <el-table-column prop="loginStatus" width="80" align="center" label="登记平台"></el-table-column>
                    ...
                    <el-table-column   align="center" label="操作">
                        <template slot-scope="scope">
                            <el-button type="text" v-if="scope.row.status == 0"  @click="goInfo(scope.row.id)">审核</el-button>
