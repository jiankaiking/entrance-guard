        ...
        <div class="searchData">
            <el-form ref="form" :model="searchData" label-width="30px">
                ...
                <el-form-item style="width: 220px">
                    <el-input v-model="searchData.ownerName" placeholder="请输入姓名"></el-input>
                </el-form-item>
                <el-form-item style="width: 220px">
                    <el-input v-model="searchData.ownerPhone" placeholder="请输入电话"></el-input>
                </el-form-item>
                <el-form-item style="width: 220px">
                    <el-input v-model="searchData.ownerRoomNo" placeholder="请输入房间号"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <div class="tableData">
            <div class="tableBox">
                <el-table :data="tableData" border empty-text style="width: 100%" v-loading="loading">
                    <el-table-column prop="ownerName" width="140" align="center" label="户主名称"></el-table-column>
                    <el-table-column prop="ownerPhone" width="140" label="联系电话" align="center"></el-table-column>
                    <el-table-column prop="ownerType" align="center" label="类型"></el-table-column>
                    ...
                    <el-table-column align="center" label="操作信息">
                        <template slot-scope="scope">
                            ...
                            <el-popover width="160" :ref="`popover-${scope.row.id}`"
