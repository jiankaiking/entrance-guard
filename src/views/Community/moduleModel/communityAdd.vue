    ...
    <div class="menuInfo">
      <el-form ref="form" :model="modelFromdata" :rules="rules" label-width="80px">
        <el-form-item label="小区" prop="communityName">
          <el-input v-model="modelFromdata.communityName" placeholder="请输入小区名称" />
        </el-form-item>
        <el-form-item label="地址" prop="regionCode">
          <city-select :city-code="modelFromdata.regionCode" @selectCode="selectCode" />
        </el-form-item>
        <el-form-item prop="communityAdress">
          <el-input v-model="modelFromdata.communityAdress" placeholder="详细地址" />
        </el-form-item>
        <el-form-item label="住宅楼数" prop="buildingCount">
          <el-input v-model="modelFromdata.buildingCount" placeholder="请输入住宅楼数" />
        </el-form-item>
        <el-form-item label="住户数" prop="householdCount">
          <el-input v-model="modelFromdata.householdCount" placeholder="请输入住户数" />
        </el-form-item>
        ...
        <el-form-item label="备注">
          <el-input
            v-model="modelFromdata.introduce"
            type="textarea"
