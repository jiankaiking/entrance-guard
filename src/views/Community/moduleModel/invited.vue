<template>
  <div class="agent-message">
    <div style="margin: 0 0 20px 20px" class="status-cont">
      ...
      <i v-if="form.status == 1" class="el-icon-success visited-status" />
    </div>
    <el-form ref="form" :model="form" :rules="rules" label-width="100px">
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="6">
          <el-form-item label="身份证">
            <el-input v-model="form.visitorIdNo" />
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="车牌号">
            <el-input v-model="form.visitorCarNo" />
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="6">
          <el-form-item label="人数" prop="visitorCount">
            <el-input v-model="form.visitorCount" />
          </el-form-item>
        </el-col>
        <el-col :span="6">
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="4">
          <el-form-item label="地址">
            <el-select v-model="buildId" placeholder="请选择住宅楼" @change="changeBuilding">
              <el-option
                v-for="item in communityBuildingArr"
                :key="item.id"
                :label="item.value"
                :value="item.id"
              />
      ...
      <div v-if="form.id" class="title">登记时间：{{ form.createTime | getTime }}</div>
      <el-form-item>
        <div style="margin: 40px auto; width: 500px">
          <el-button @click="cancel">取消</el-button>
          <el-button v-if="!form.status" class="myDefult-btn" plain @click="onSubmit('form')">保存</el-button>
          <el-button v-if="form.status == 0" type="info" @click="applyInvited('5')">驳回</el-button>
          <el-button v-if="form.status == 0" class="myDefult-btn" plain @click="applyInvited('1')">通过</el-button>
        </div>
      </el-form-item>
    </el-form>
  </div>
