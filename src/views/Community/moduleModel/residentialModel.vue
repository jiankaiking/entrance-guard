...
<!--                    <el-input v-model="modelFromdata.communityName"  placeholder="请选择小区" ></el-input>-->
                ...
                <el-form-item label="住宅楼名称"  prop="buildingName">
                    <el-input v-model="modelFromdata.buildingName"  placeholder="住宅楼名称" ></el-input>
                </el-form-item>
                <el-form-item label="单元名称"  prop="unitName">
                    <el-input v-model="modelFromdata.unitName" placeholder="单元名称"></el-input>
                </el-form-item>
                <el-form-item label="楼层数" prop="floor">
                    <el-input v-model="modelFromdata.floor" placeholder="请输入楼层数"></el-input>
                </el-form-item>
                <el-form-item label="单层房间数" prop="room">
                    <el-input v-model="modelFromdata.room" placeholder="请输入单层房间数"></el-input>
                </el-form-item>
                ...
                <el-form-item label="备注">
                    <el-input type="textarea" placeholder="字数不能超过50个字符" :rows="6" maxlength="50" show-word-limit
                              v-model="modelFromdata.remarks"></el-input>
                </el-form-item>
            </el-form>
            <div class="btn-box">
