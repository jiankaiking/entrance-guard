<template>
    <el-form label-width="120px" :model="modelFromdata" style="padding: 0 80px; box-sizing: border-box">
        <el-form-item label="任务名称">
            <el-input placeholder="请输入内容" v-model="modelFromdata.taskName">
            </el-input>
        </el-form-item>
        <el-form-item label="执行类">
            <el-input placeholder="请输入内容" v-model="modelFromdata.taskClass">
            </el-input>
        </el-form-item>
        <el-form-item label="任务执行规则">
            <el-input placeholder="请输入内容" v-model="modelFromdata.taskRunCron">
            </el-input>
        </el-form-item>
        <el-form-item label="任务状态">
            <el-select placeholder="请选择活动区域" v-model="modelFromdata.taskStatus">
                <el-option label="停止" :value="0">停止</el-option>
                <el-option label="正常" :value="1">正常</el-option>
            </el-select>
        </el-form-item>
        <el-form-item label="执行时间(分)">
            <el-input placeholder="请输入内容" v-model="modelFromdata.taskRunTime">
            </el-input>
        </el-form-item>
        <el-form-item label="任务描述">
            <el-input placeholder="请输入内容" type="textarea" v-model="modelFromdata.taskDesc">
            </el-input>
        </el-form-item>
