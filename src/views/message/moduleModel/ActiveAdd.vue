  ...
  <div class="business-form padding-all">
    ...
    >
      ...
      <el-form-item :label="modelFromdata.newsModule == 1?'公告主题':'活动主题'" prop="subject">
        <el-col :span="8">
          <el-input v-model="modelFromdata.subject" placeholder="请输入活动主题" />
        </el-col>
      </el-form-item>
      <el-form-item :label="modelFromdata.newsModule == 1?'公告类型':'活动类型'" prop="newsType">
        <el-col :span="8">
          <CommonSelect
            ...
            :type="modelFromdata.newsType == 1?'news_notice_type':(modelFromdata.newsType == 2?'news_merch_activity_type':'news_agent_activity_type')"
          />
        </el-col>
      </el-form-item>
      <el-form-item label="通知对象" prop="noticeObjectType">
        ...
        <el-col :span="8">
          <el-checkbox-group v-model="modelFromdata.noticeObjectType" @change="handleCheckedCitiesChange">
            <el-checkbox v-for="city in cities" :key="city.val" :label="city.val">{{ city.name }}
            </el-checkbox>
          </el-checkbox-group>
        </el-col>
      </el-form-item>
      <el-form-item style="vertical-align: top" label="活动有效期" prop="endTime">
        <el-col :span="6">
          <el-date-picker
            v-model="modelFromdata.startTime"
      ...
      <el-form-item label="缩略图" prop="thumbnailUrl">
        <uploadImg :img-url.sync="modelFromdata.thumbnailUrl" />
      </el-form-item>
      <el-form-item v-if="modelFromdata.newsModule != 1" label="活动海报" prop="postersUrl">
        <uploadImg :img-url.sync="modelFromdata.postersUrl" />
      </el-form-item>
      <el-form-item label="活动内容" prop="content">
        <el-col :span="15">
          <el-input
            v-model="modelFromdata.content"
            type="textarea"
