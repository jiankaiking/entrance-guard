        ...
        <div class="searchData">
            <el-form ref="form" :model="searchData" label-width="100px">
                ...
                <el-form-item label="类型" label-width="40px">
                    <CommonSelect :value.sync="searchData.newsType" type="news_agent_activity_type"></CommonSelect>
                </el-form-item>
                ...
                <el-button type="success" plain @click="headAdd(3)">新增</el-button>
            </el-form>
        </div>
        <div class="tableData">
            <div class="tableBox">
        ...
        data() {
            return {
                searchData: {
                    ...
                    subject:'', //主题
                    newsModule:'3', //消息所属模块 1 公告 2 商户活动 3 代理商活动
                    status:'', //活动状态
                    newsType:'',//消息类型
                    size: 10,
                    currentPage: 1
