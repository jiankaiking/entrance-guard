        ...
        <el-form label-width="120px" ref="form" :model="modelFromdata" :rules="rules">
            <el-form-item label="设备厂家" prop="factoryId">
                <el-select v-model="modelFromdata.factoryId" clearable placeholder="请选择区域类型">
                    <el-option v-for="item in factoryAllArr" :label="item.value" :value="item.id + '-' + item.value"></el-option>
                </el-select>
            </el-form-item>
            ...
            <el-form-item label="设备类型" prop="equipmentTypeId">
                <el-select v-model="modelFromdata.equipmentTypeId" clearable placeholder="请选择区域类型">
                    <el-option v-for="item in equipmentType" :label="item.value" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="IP地址" prop="ipAdress">
                <el-input v-model="modelFromdata.ipAdress"  placeholder="输入IP地址"/>
            </el-form-item>
<!--            <el-form-item label="小区" prop="areaTypeId">-->
<!--                <el-select v-model="modelFromdata.areaTypeId" clearable placeholder="请选择小区">-->
<!--                    <el-option v-for="item in communityArr" :label="item.value" :value="item.id"></el-option>-->
<!--                </el-select>-->
<!--            </el-form-item>-->
            <el-form-item label="管理区域" prop="areaId">
<!--                <el-select v-model="modelFromdata.areaId" clearable placeholder="请选择管理区域">-->
<!--                    <el-option v-for="item in equipmentType" :label="item.value" :value="item.id"></el-option>-->
<!--                </el-select>-->
                <el-cascader
                        :options="options"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ok() {
                let f = this.modelFromdata.factoryId.split('-')
                console.log( this.modelFromdata)
