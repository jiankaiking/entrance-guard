    ...
    <div class="main-contenner">
        <div class="eqioment-type">
            <el-form label-width="50px">
                <el-form-item>
                    <el-button type="success" @click="addAreaType" plain>新增区域类型</el-button>
                </el-form-item>
            </el-form>
        </div>
        <div class="tableData">
            <div class="tableBox">
                <el-table :data="tableData" border empty-text style="width: 100%" v-loading="loading">
                    <el-table-column type="index" width="300" align="center" label="序号"></el-table-column>
                    <el-table-column prop="areaTypeName" label="区域类型名称" align="center"></el-table-column>
                    <el-table-column label="图片" align="center">
                        <template slot-scope="scope">
                            <el-image style="width:50px; height:50px" :src="scope.row.areaImgUr" :preview-src-list="[scope.row.areaImgUr]"></el-image>
                        </template>
                    </el-table-column>
