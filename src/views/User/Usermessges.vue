<template>
  <div v-loading="loading" class="userMessges clear">
    <div class="user-via">
      <el-image
        ...
        <el-row :gutter="20">
          <el-col :span="7">
            <el-form-item label="用户名">
              <el-input v-model="userMsg.userName" readonly />
            </el-form-item>
          </el-col>
          <el-col :offset="2" :span="7">
            <el-form-item label="手机号">
              <el-input v-model="userMsg.phone" readonly />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="7">
            <el-form-item label="邮箱">
              <el-input v-model="userMsg.loginEmail" readonly />
            </el-form-item>
          </el-col>
          <el-col :offset="2" :span="7">
            <el-form-item label="部门">
              <el-input :value="userMsg.organName" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="7">
            <el-form-item label="创建时间">
              <el-input :value="userMsg.createTime" />
            </el-form-item>
          </el-col>
          <el-col :offset="2" :span="7">
            <el-form-item label="所属角色">
              <el-input :value="userMsg.roleName" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-form-item label="首页设置">
          <div>
            <el-checkbox v-model="userMsg.isShowCommonFunc" true-label="1" false-label="0">常用功能
            </el-checkbox>
          </div>
          <div>
            <el-checkbox v-model="userMsg.isShowHotNews" true-label="1" false-label="0">热门新闻</el-checkbox>
          </div>
          <div>
            <el-checkbox v-model="userMsg.isShowQrcode" true-label="1" false-label="0">常用二维码</el-checkbox>
          </div>
        </el-form-item>
        <el-form-item>
